...
class Binomial(Distribution):
    ...
    def __init__(self, prob=.5, size=20):
        ...
        Distribution.__init__(self,self.mean,self.std)
    ...
    def calculate_stdev(self):
        ...
        self.std = math.sqrt(self.n * self.prob * (1 - self.prob))
    ...
    def replace_stats_with_data(self):
        ...
        self.prob = np.array(self.data).sum()/self.n

        self.mean = self.calculate_mean()
        self.std = self.calculate_stdev()

        return self.prob, self.n
    ...
    def pdf(self, k):
        ...
        total_outcomes = math.factorial(self.n)/ (math.factorial(k)*(math.factorial(self.n-k)))
        p_for_each = math.pow(self.prob,k) * math.pow((1 - self.prob),(self.n - k))

        pdf = total_outcomes * p_for_each
    ...
    def plot_bar_pdf(self):
        ...
        plt.bar(x, y)
        plt.set_title('Binomial Distribution for the outcomes')
    ...
    def __repr__(self):
        ...
        return "mean {}, standard deviation {}, p {}, n {}".format(self.mean, self.std, self.prob, self.n)
